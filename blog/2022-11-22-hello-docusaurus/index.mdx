...
The site is deployed on very push to the `master` branch. The [code](https://github.com/Zwyx/zwyx.dev/blob/master/.github/workflows/build-website.yml) should be self-explanatory with enough knowledge on [GitHub Actions](https://docs.github.com/en/actions) and [GitHub Pages](https://docs.github.com/en/pages).

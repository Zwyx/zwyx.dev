...
description: Use a persistent Docker container to protect you from malicious packages.
image: ./dockerDev1Resized.webp
authors: [alex]
tags: [docker, security, npm, node, vscode]
---

import { Image } from "@site/src/components/Image";
import dockerDev from "./dockerDev1Resized.webp";
...
<Image src={dockerDev} alt="Docker Dev" />

Run a **single Docker container** that stays active, and drop into it whenever you need to work on a Node project.

This "system-wide" container:
...
:::info[Note]
Working inside a dev container doesn't create any overhead on Linux, as Docker works natively there. If you use another system, your experience may vary.
:::
...
:::info[Note]
This container is quite tied to my personal configuration and preferences. If something doesn't work for you, open `Dockerfile` and `docker-compose.yml` to make any necessary adjustments.
:::

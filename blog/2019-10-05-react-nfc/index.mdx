...
import reactNfc from "./react-nfc.png";
...
:::info
If an error occurs, see the first point in the **Notes** <!-- [Notes](#notes) --> section below.
:::
...
import nfcUnavailable from "./nfc-unavailable.png";
...
import { ImageLegend } from "@site/src/components/ImageLegend";

<ImageLegend>Our web app on an Android device with NFC not enabled</ImageLegend>
...
:::info
If an error occurs, see the second point in the **Notes** <!-- [Notes](#notes) --> section below.
:::

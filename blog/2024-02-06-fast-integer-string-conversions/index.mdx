...
# image:
authors: [alex]
tags: [base conversion, v8, integer, bigint, string, algorithm, javasrcipt]
---
...
For this too, Chrome's `BigInt` is much faster, and uses a different algorithm, [« divide-and-conquer conversion »](https://github.com/v8/v8/blob/main/src/bigint/tostring.cc).
